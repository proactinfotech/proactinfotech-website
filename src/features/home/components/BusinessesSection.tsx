  ...
  return (
    ...
    >
      ...
      <img 
        src="/images/logo.png" 
        alt={`${biz.name} logo`}
        className="relative w-24 h-24 md:w-40 md:h-40 object-contain opacity-30"
      />
      
      {/* Number in corner */}
      <span
        className="absolute top-6 right-6 md:top-8 md:right-8 select-none font-display text-2xl md:text-4xl font-bold leading-none tracking-tighter text-white/20"
        aria-hidden
      >
        {zeroPad(index)}
      </span>
